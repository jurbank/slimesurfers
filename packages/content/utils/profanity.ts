...
const BAD_WORDS = [
  ...
  "faggot",
  "retard",
  "nigga", "n1gger", "n1gga", "negro", "n3gro", "n!gger", "n!gga",
  "faggot", "fag", "f4ggot", "f4g", "f@ggot", "f@g", "fagg0t", "f@gg0t",
  "chink", "gook", "spic", "kike", "kyke", "ch1nk", "g00k", "sp1c", "k1ke",
  "retard", "r3tard", 'muslim', 'muslims', 'jewish', 'jew', "tard", "cunt", "r3t@rd", "ret@rd", "c*nt", "c@nt",
  ...
  "whore", "wh0re", "sl*t", "b!tch", "b*tch", "h0e", "hoe",
